...
// Only show messages from last 15mins
const MINS_DURATION = 15

function Messages() {
  const {user} = useMoralis();
  const endfOfMessageRef = useRef(null);
  ...
  return (
    <div className='pb-56'>
      ...
      <div className='flex justify-center'>
        <SendMessage endfOfMessageRef />
      </div>

      <div ref={endfOfMessageRef} className='text-center text-gray-400 mt-5'>
